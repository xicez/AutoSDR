...
def autoSequencer(email, password, prospectEmail, prospectCampaign, OutreachTemplate, chromedriver_path, numLeads):
	...
	for lead in prospectEmail:
		...
		#Sequence is correct at this point- time to select the template! 
		editSteps = driver.find_element(By.XPATH, "//button[text()='Edit steps']")
		editSteps.click()

		time.sleep(1)
		
		selectTemplate = driver.find_element(By.XPATH, "//button[@class='_1J9auNZ1G_Y61aDnVgMKAj _1ylTesnUFCUoPnsDHUtF0P _2RPbK6gdjbuOROI4ZVT6jz WUzSC5qS191f9WgODZkSL']")
		selectTemplate.click()

		templateSearchBox = driver.find_element(By.XPATH, "//input[@placeholder='Filter templates…']")
		templateSearchBox.send_keys(OutreachTemplate)
		time.sleep(2)

		correctTemplate = driver.find_element(By.XPATH, f"//button[text()='{OutreachTemplate}'")
		correctTemplate.click()

		time.sleep(1)
		doneButton = driver.find_element(By.XPATH, "//span[text()='Done']")
		doneButton.click()
