...
# ATTENTION ---- ATTENTION 
# UPDATE THE SEQUENCING PROCESS TO USE 'ADD PROSPECT' BUTTON INSTEAD OF GOING TO EACH PROFILE INDIVIDUALLY 
# THIS SHOULD BE MUCH MUCH MUCH EASIER AND LESS PRONE TO BUGS!!!
...
def autoSequencer(email, password, prospectEmail, prospectCampaign, chromedriver_path, prospectCountText, numLeads, numContactsSeq, window):
